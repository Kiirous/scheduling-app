...
class ProfessionalBasicInfoArea extends AppStateless {
  const ProfessionalBasicInfoArea({super.key, required this.professional, this.enableTap = true});
  ...
  Widget builder(BuildContext context, AppTheme theme) {
    return InkWell(
      onTap: enableTap
          ? () {
              context.push(AppRoutes.professionalDetails.fullPath(id: professional.id));
            }
          : null,
      child: Row(
        children: [
